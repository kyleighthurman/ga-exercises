...
for (var i = 0; i < flickerObj.items.length; i++) {
  console.log('item  = flickerObj.items['+i+']');
  var item = flickerObj.items[i];
  //console.log('\n\n\n');
...
var links = [];
flickerObj.items.forEach(function(stuff){
  //console.log('NOTICE ME',stuff.link);
  links.push(stuff.link);
  console.log('NOTICE ME',links);
});
